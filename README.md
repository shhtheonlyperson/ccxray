...
The launcher argument is provider-backed. Today `claude` is supported; unknown provider commands fail fast instead of silently starting an unconfigured proxy.
